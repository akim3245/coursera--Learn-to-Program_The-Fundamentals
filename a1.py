...
def get_hours(seconds):
    ...
    Return the number of hours that have elasped since midnight, as seen on a 24-hour clock in the specified time in seconds.
...
def get_minutes(seconds):
    ...
    Return the number of minutes that have elapsed since minight as seen on a clock in the specified time in minutes.
...
def get_seconds(seconds):
    ...
    Return the number of seconds that elapsed since midnight in the specified time in seconds.
